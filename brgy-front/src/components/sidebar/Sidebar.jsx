...
import { ClipboardClock, Bookmark, UserRoundPen, LogOut } from 'lucide-react';
import defaultProfile from '../../assets/img/defaultProfile.png';
import Logo from '../../assets/img/logo.png';
import { Link } from 'react-router-dom';

const Sidebar = ({isSidebarOpen, menuOpen, setMenuOpen}) => {
    ...
    const menuItems = [
        {
            ...
            icon: ClipboardClock,
            path: '/clientBookAppointment'
        },
        {
            key: 'myAppointment',
            name: 'My Appointment',
            icon: Bookmark,
            path: '/clientMyAppointment'
        },
        {
            key: 'profile',
            name: 'Profile',
            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start rtl:justify-end">
                        ...
                        <img src={Logo} className="h-8 me-3" alt="Brgy Logo" />
                        <span className="self-center text-[var(--text)] text-[16px] font-semibold md:text-xl lg:text-xl whitespace-nowrap">Brgy Rosario Appointment System</span>
                        </a>
                    </div>
                        ...
                        <div className="flex items-center ms-3">
                            <div>
                                <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                                    ...
                                    <img className="w-8 h-8 object-contain rounded-full" src={defaultProfile} alt="user photo"/>
                                </button>
                            </div>
                ...
                <ul className="space-y-2 font-medium">
                    {menuItems.map((item) => (
                        <li>
                            ...
                            >
                                <item.icon size={20} className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
                    ...
                    <li>
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">My Appointment</span>
