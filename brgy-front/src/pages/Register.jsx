        ...
        <div className='min-h-screen flex flex-col'>
            <div className='sticky top-0 z-50 w-full' id='client-login'>
              <div className='flex items-center bg-[var(--accent)] p-2.5'>
                  ...
                  <span className='text-[16px] !text-[#0f172a] lg:text-[25px] ml-3.5'>
                  ...
                  <div className='ml-auto pr-1 lg:pr-10'>
                      <Link to="/admin" className="focus:outline-none !text-[#0f172a] bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Admin</Link>
                  </div>
              </div>

            </div>
            <div className='flex flex-1 items-center justify-center'>
                <div className="w-full m-3 max-w-3xl p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                  <form class="max-w-xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                      ...
                      <div class="relative z-0 w-full mb-5 group">
                          <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">District</label>
                    ...
                    <div className=''>
                      <button type="submit" class="block mb-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
