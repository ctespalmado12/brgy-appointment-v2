  ...
  return (
    <div>
        <div className='min-h-screen flex flex-col'>
            <div className='' id='client-login'>
                <div className='flex items-center bg-[var(--accent)] p-2.5'>
                <img className='w-[85px]' src={Logo} alt="Barangay logo" />
                <span className='text-[25px] ml-3.5 text-white'>
                    Barangay Rosario Appointment System
                </span>
                
                {/* Pushes this div to the far right */}
                <div className='ml-auto pr-10'>
                    <Link className='button text-xl !p-3'>Admin</Link>
                </div>
                </div>
